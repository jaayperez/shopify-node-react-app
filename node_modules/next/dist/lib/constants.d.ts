...
export declare const SERVER_PROPS_SSG_CONFLICT = "You can not use getStaticProps with getServerSideProps. To use SSG, please remove getServerSideProps";
...
export declare const NON_STANDARD_NODE_ENV = "You are using a non-standard \"NODE_ENV\" value in your environment. This creates inconsistencies in the project and is strongly advised against. https://err.sh/next.js/non-standard-node-env";
