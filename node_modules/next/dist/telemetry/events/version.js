...
if(typeof "9.4.1"!=='string'){return[];}const userConfiguration=getNextConfig(phase,dir);const payload={nextVersion:"9.4.1",nodeVersion:process.version,cliCommand:event.cliCommand,isSrcDir:event.isSrcDir,hasNowJson:event.hasNowJson,isCustomServer:event.isCustomServer,hasNextConfig:!!userConfiguration,buildTarget:(_userConfiguration$ta=userConfiguration===null||userConfiguration===void 0?void 0:userConfiguration.target)!==null&&_userConfiguration$ta!==void 0?_userConfiguration$ta:'default',hasWebpackConfig:typeof(userConfiguration===null||userConfiguration===void 0?void 0:userConfiguration.webpack)==='function',hasBabelConfig:hasBabelConfig(dir)};return[{eventName:EVENT_VERSION,payload}];}